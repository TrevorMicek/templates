        ...
        <div>
          <article className={styles.firstSectionText}>
            <p>
              ...
              sed do eiusmod tempor incclassNameclassNameunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, 
      ...
      <section className={styles.secondSection}>
        ...
        <div>
          ...
          <p className={styles.FirstText}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incclassNameclassNameunt ut labore et dolore magna.
          </p>
        </div>
        <div>
